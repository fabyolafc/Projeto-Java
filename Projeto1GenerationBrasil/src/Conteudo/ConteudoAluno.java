...
public class ConteudoAluno {
	...
	public static void main(String[] args) {
		...
		}else if (op==2)
		{
			...
			do
			{
				System.out.println("\n2 - Qual tipo de dado é usado para criar uma variável que deve armazenar texto ?");
				System.out.println("\n[1] string");
				System.out.println("\n[2] myString");
				System.out.println("\n[3] String");
				System.out.println("\n[4] Txt");
			...
			do
			{
				System.out.println("\n3 - Qual tipo de dado é usado para criar uma variável que deve armazenar número do tipo inteiro ?");
				System.out.println("\n[1] double");
				System.out.println("\n[2] float");
				System.out.println("\n[3] String");
				System.out.println("\n[4] int");
